...
<link rel="stylesheet" href="assets/bootstrap/plugins/icomoon/style.css" type="text/css">	
 <!--LTE-->
		...
		<aside id="sidebar" class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class=""><a href="#"> <i
							class="fa fa-dashboard"></i> <span>Quản lý nội dung</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							...
							<li><a href="grant_role.jsp"><i class="fa fa-circle-o"></i>Quản lí</a></li>
						</ul></li>
				</ul>
			</section>
			<!-- /.sidebar -->
