...
<n:check value="${param.crud_type}" minLength="3" maxLength="200"
	type="string" exp="[0-9a-zA-Z_/.]+">Tham số không chính xác, vui lòng kiểm tra lại!</n:check>
...
<link rel="stylesheet"
	href="/assets/bootstrap/plugins/icomoon/style.css">
</head>
